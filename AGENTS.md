...
## Purpose
This repository contains CTS Mining Axle Inspection, an offline-only Android tablet app for field mining axle inspections. These notes define the working rules, architecture direction, test loop, and release criteria for the codebase and its docs.
